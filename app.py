...
if app.config['DB_TYPE'] == 'postgres':
    db_name = 'dayana_shamshieva_orm'
    db_user = 'dayana_shamshieva_orm'
    db_password = '123'
    host_ip = '127.0.0.1'
    host_port = 5432
    ...
    db_path = path.join(dir_path, "dayana_shamshieva_orm.db")
...
<html>
    <body>
        ...
        <ol>
            ...
            <li>
                <a href="/lab8">Лабораторная VIII</a>
            </li>
            <li>
                <a href="/lab9">Лабораторная IX</a>
            </li>
            <li>
                <a href="/rgz">РГЗ</a>
            </li>
